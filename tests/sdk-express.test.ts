...
import { expressMiddleware } from "@dexter.js/monitor/instrumentors/express";
import { traceStore, currentTraceId } from "@dexter.js/monitor/context";

// We need to mock getEmitter() so the middleware can emit without a real socket.
vi.mock("@dexter.js/monitor/init", () => {
